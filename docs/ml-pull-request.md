...
Opening a pull request will trigger a[workflow](../.github/workflows/mlopsdemo-run-tests.yml) 
...
Links:
* [Staging model in UC](https://e2-demo-field-eng.cloud.databricks.com/explore/data/models/staging/mlopsdemo/mlopsdemo-model)
* [Prod model in UC](https://e2-demo-field-eng.cloud.databricks.com/explore/data/models/prod/mlopsdemo/mlopsdemo-model)
. 
