...
git add README.md docs .gitignore mlopsdemo/resources/README.md
...
If you want to use different catalog names, please update the target names declared in the[mlopsdemo/databricks.yml](../mlopsdemo/databricks.yml) file.
...
Follow the instructions in [mlopsdemo/resources/README.md](../mlopsdemo/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../mlopsdemo/resources/README.md)  to propose, test, and deploy
