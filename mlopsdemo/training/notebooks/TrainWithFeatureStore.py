...
# ``mlopsdemo/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "model_name", "dev.leoncmlopsdemo.mlopsdemo-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.leoncmlopsdemo.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.leoncmlopsdemo.trip_dropoff_features",
